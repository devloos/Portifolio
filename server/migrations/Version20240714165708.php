...
final class Version20240714165708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE experience CHANGE created_at created_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', CHANGE modified_at modified_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\'');
